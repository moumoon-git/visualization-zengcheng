...
export default {
  ...
  data() {
    return {
      tabList: [
        { name: "事件要情", flag: false, index: 0 },
        // { name: "应急预案", flag: false, index: 1 },
        { name: "资源检索", flag: false, index: 2 },
        { name: "任务管理", flag: false, index: 6 },
        // { name: "轨迹查看", flag: false, index: 3 },
        // { name: "图层历史", flag: false, index: 4 }
        // {name:'截图历史',flag:false,index:5}
      ],
      map: "",
    };
  },
  methods: {
    ...
    hideRight() {
      this.$parent.eventManagements();
      this.$refs.reveal.$refs.taskManagement.clearMap();
      // this.$refs.reveal.$refs.teamRoute.clearMap();
    }
  },
  components: {
    reveal
