  ...
  export default{
    ...
    methods: {
      clickSelect(item,index) {
        ...
        item.flag = true
        this.$emit('clickSelects',{data:item,ind:index,type:'fh'})
      },
      init (arrData) {
        console.log(arrData)
        arrData.forEach(ele=>{
...
.iconImg{
  ...
  height:40px;
  margin-right: 19px;
  background:url("../../../../../../assets/images/cszh/fence.png")no-repeat;
  background-size: 100% 100%;
}
.IconActive{
  display: inline-block;
  ...
  height:40px;
  margin-right: 19px;
  background:url("../../../../../../assets/images/cszh/fence1.png")no-repeat;
  background-size: 100% 100%;
}
.content>h3{
  font-size:16px;
